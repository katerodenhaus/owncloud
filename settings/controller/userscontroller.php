...
class UsersController extends Controller
{
     ...
     */
    public function setReminders($username, $reminderEmail, $reminderHipchat, $reminderMins)
    {
        $currentUser = $this->userSession->getUser();
        ...
        if ($user->setReminders($reminderEmail, $reminderHipchat, $reminderMins)) {
            return new DataResponse([
                                        'status' => 'success',
                                        'data'   => [
                                            'message'   => $this->l10n->t('Your reminder preferences have been updated.'),
                                            'username'  => $username,
            ...
            return new DataResponse([
                                        'status' => 'error',
                                        'data'   => [
                                            'message'     => $this->l10n->t('Unable to change your reminder preferences'),
                                            'displayName' => $user->getDisplayName(),
                                        ],
                                    ]);
        }
